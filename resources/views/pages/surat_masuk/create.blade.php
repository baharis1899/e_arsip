...
<div class="mt-5  card shadow">
    <form class="card-body" action="{{route('suratmasuk.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            <label for="sender">Masukan Surat Pengirim</label>
            <input type="text" class="form-control" id="sender" name="sender" placeholder="Masukan Pengirim" required>
        </div>
        <div class="form-group">
